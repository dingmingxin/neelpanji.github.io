...
function initStripeForReal() {
    ...
    $('#id_email').on("keyup", debounce(function() {
        var email = this.value;
        if (ajax) {
            ajax.abort();
        }
...
$(document).ready(function() {
    ...
    $('#clear-puzzle').on('click', function() {
    ...
    function gradeAll() {
        for (var index in index_to_direction) {
            ...
            if (is_empty) {} else if (user_string.toUpperCase() == grid_string.toUpperCase()) {
